            ...
            if (!CollectionUtils.isEmpty(bookInfos)) {
                ...
                return homeBooks.stream().map(v -> {
                    ...
                    if (bookInfo != null) {
                        ...
                        // Set default values or handle the null case appropriately
                        bookRespDto.setBookName("missing name");
                        bookRespDto.setPicUrl("/localPic/2020/12/12/ninja.jpg");
                        bookRespDto.setAuthorName("baobao");
                        bookRespDto.setBookDesc("Description not available");
                    }
                    return bookRespDto;
                }).toList();
